...
with tabs[0]:
    ...
    if st.session_state.bot_running:
        st.info(f"🟢 Бот сканирует **{len(tokens)}** токенов на **{len(connected)}** биржах каждые 3 секунды.")
...
if show_admin:
    with tabs[-1]:
        ...
        a1, a2, a3, a4, a5, a6 = st.tabs(["👥 Участники","📊 Токены","🔐 API ключи","📜 Все сделки","💰 Заявки","⚙ Сброс балансов"])
        with a1:
